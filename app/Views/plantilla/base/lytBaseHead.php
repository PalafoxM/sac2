    ...
    <script>            
        ...
        <div class="leftbar-tab-menu">
            <div class="main-icon-menu">
                <a href="<?php echo base_url(); ?>analytics/analytics-index.html" class="logo logo-metrica d-block text-center">
                    <span>
                ...
                <nav class="nav">
                    ...
                    <a href="#MetricaApps" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Categorias/Cursos" data-trigger="hover">
                        <i data-feather="grid" class="align-self-center menu-icon icon-dual"></i>
                    </a><!--end MetricaApps-->
                    <?php endif; ?>
                   <?php if($session->id_perfil==1): ?>
                    <a href="#MetricaUikit" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Administrador" data-trigger="hover">
                        <i data-feather="package" class="align-self-center menu-icon icon-dual"></i>
                    </a><!--end MetricaUikit-->
                    <?php endif; ?>
                    <a href="#MetricaPages" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Programar" data-trigger="hover">
                ...
                <div class="menu-body slimscroll">                    
                    <div id="MetricaAnalytics" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>analytics/analytics-reports.html">No aprobados</a></li> 
                        </ul>
                    </div><!-- end Analytic -->
                    ...
                    <div id="MetricaApps" class="main-icon-menu-pane">
                        ...
                        <ul class="nav metismenu">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Inicio/categorias">Categorias</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Principal/Matricular">Cursos</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>apps/calendar.html">Pre-Inscripción</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>apps/invoice.html">Inscritos</a></li>                            
                        </ul>
                    </div><!-- end Crypto -->
                    <?php if($session->id_perfil==1): ?>
                    <div id="MetricaUikit" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                          ...
                          <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Inicio/adminCategorias">Administración</a></li>
                          <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Inicio/usuarios">Lista Usuarios</a></li>
                          <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Inicio/altaUsuario">Alta usuario</a></li>
                   ...
                   <?php endif; ?>
                    ...
                    <div id="MetricaAuthentication" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-login.html">Log in</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-login-alt.html">Log in alt</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-register.html">Register</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-register-alt.html">Register-alt</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-recover-pw.html">Re-Password</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-recover-pw-alt.html">Re-Password-alt</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-lock-screen.html">Lock Screen</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-lock-screen-alt.html">Lock Screen</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-404.html">Error 404</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-404-alt.html">Error 404-alt</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-500.html">Error 500</a></li>                            
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>authentication/auth-500-alt.html">Error 500-alt</a></li>
                        </ul>
                ...
                <ul class="list-unstyled topbar-nav float-right mb-0"> 
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo base_url()?>index.php/Login/cerrar"><i class="dripicons-exit text-muted mr-2"></i> Salir</a>
                        </div>
                    </li>
                    <li class="mr-2">
                            ...
                            <div class="row no-gutters">
                                    ...
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="<?php echo base_url(); ?>assets/images/dashboard/dash-1.png" class="d-block img-fluid" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="<?php echo base_url(); ?>assets/images/dashboard/dash-4.png" class="d-block img-fluid" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="<?php echo base_url(); ?>assets/images/dashboard/dash-2.png" class="d-block img-fluid" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="<?php echo base_url(); ?>assets/images/dashboard/dash-3.png" class="d-block img-fluid" alt="...">
                                            </div>                                            
                                        </div>                                        
                                    </div>                                    
                                </div><!--end col-->
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="p-4 text-left">                                        
                                        <div class="row">                                            
                                            <div class="col-6">
                                                <a class="dropdown-item mb-2" href="<?php echo base_url(); ?>analytics/analytics-index.html"> Analytics</a>
                                                <a class="dropdown-item mb-2" href="<?php echo base_url(); ?>crypto/crypto-index.html"> Crypto</a>
                                                <a class="dropdown-item mb-2" href="<?php echo base_url(); ?>crm/crm-index.html"> CRM</a>
                                                <a class="dropdown-item" href="<?php echo base_url(); ?>projects/projects-index.html"> Project</a>
                                            </div>
                                            <div class="col-6">
                                                <a class="dropdown-item mb-2" href="<?php echo base_url(); ?>ecommerce/ecommerce-index.html"> Ecommerce</a>
                                                <a class="dropdown-item mb-2" href="<?php echo base_url(); ?>helpdesk/helpdesk-index.html"> Helpdesk</a>
                                                <a class="dropdown-item" href="<?php echo base_url(); ?>hospital/hospital-index.html"> Hospital</a>
                                            </div>
                                        </div>
                                    </div>                                    
                                </div><!--end col-->
